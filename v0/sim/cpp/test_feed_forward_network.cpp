// =============================================================================
// test_feed_forward_network.cpp -- Harness for feed_forward_network.
//
// stdin:  SEQ_LEN * EMBED_DIM int16 -- input_data, row-major
// stdout: SEQ_LEN * EMBED_DIM int16 -- output_data, row-major
// =============================================================================
#include "Vfeed_forward_network.h"
#include "Vfeed_forward_network___024root.h"
#include "common.h"
...
int main(int argc, char** argv) {
    ...
    auto* dut = new Vfeed_forward_network;
